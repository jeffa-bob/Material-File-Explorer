...
namespace Materialfile
{
  ...
  {
    public static CurDirectory cur = new CurDirectory();
    public MainWindow()
    {
    ...
    {
      if (System.IO.Directory.GetParent(cur.CurDir.FullName) != null) { cur.CurDir = System.IO.Directory.GetParent(cur.CurDir.FullName);cur.getitems(); System.Console.WriteLine(cur.CurDir.FullName);}
      else
      {
